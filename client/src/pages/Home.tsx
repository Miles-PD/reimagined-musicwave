                ...
                <div className="flex flex-row relative object-contain overflow-hidden">
                    <div className="flex flex-row w-2/4 h-96 bg-red-400">
                        ...
                        <section className='opacityOverlay group group-hover:relative z-10'>
                            <div className="absolute left-0 w-full h-full group-hover:block z-2">
                                <div className="hidden absolute bottom-0 left-0 w-2/4 h-40 bg-black backdrop-blur-sm animate-slideup_faster opacity-75 group-hover:block" />
                            </div>
                    ...
                    <div className="w-2/4 bg-green-400">
